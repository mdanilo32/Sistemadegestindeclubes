...
export default function RegisterEnlace() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    // Reset departamento y municipio cuando cambia la región
    if (name === 'region') {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Solicitud enviada correctamente. Estado: PENDIENTE DE APROBACIÓN');
    navigate('/login');
  };
    ...
    <div className="min-h-screen bg-[#f5f7fa] py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-3xl text-[#1e3a5f] mb-2">Registro de Enlaces Voluntarios</h1>
          <p className="text-gray-600">Complete el formulario para solicitar acceso al sistema</p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-blue-800">
                ...
                Una vez aprobada, podrá acceder al sistema y gestionar clubes y participantes.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  placeholder="Ej: Licenciado en Biología"
                />
              </div>
              <div>
